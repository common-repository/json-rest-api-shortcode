...
Tags: WP API, JSON REST API Shortcode
...
This plugin offers developers a simple block of code for hello-worlding the WP API, and a shortcode to watch it in action: [wp_api].
